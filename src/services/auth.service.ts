...
export class AuthService implements OnInit{
  ...
  refreshTokens(): Observable<responseRefreshToken> {
    ...
    return this.http.post<responseRefreshToken>(`http://${configDev.host}:${configDev.port}/refresh`, jsonBody, httpOptions);
  }
  ...
  signUp(nickname: string, email: string, password: string): Observable<responseUserDataAuth> {
    ...
    return this.http.post<responseUserDataAuth>(`http://${configDev.host}:${configDev.port}/signup`, jsonBody, httpOptions);
  ...
  logIn(email: string, password: string): Observable<responseUserDataAuth> {
    ...
    return this.http.post<responseUserDataAuth>(`http://${configDev.host}:${configDev.port}/login`, jsonBody, httpOptions);
  ...
  googleAuth(nickname: string, email: string, provider: string): Observable<responseUserDataAuth> {
    ...
    return this.http.post<responseUserDataAuth>(`http://${configDev.host}:${configDev.port}/signup/google`, jsonBody, httpOptions);
  ...
  logOut(): Observable<responseStatus> {
    ...
    return this.http.post<responseStatus>(`http://${configDev.host}:${configDev.port}/logout`, jsonBody, httpOptions);
  }
